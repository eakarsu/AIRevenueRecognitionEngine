...
const FEATURE_SLUG = 'no-performanceobligationtracking-ai-progress';
const FEATURE_TITLE = 'No /performance-obligation-tracking AI (progress to satisfaction)';
const PROJECT = 'AIRevenueRecognitionEngine';
